...
/*
//=========================SINGLE LINKED LIST FUNCTION PROTOTYPING========================

//INSERTION SLL

char charFnIHSLL(int intArr[]); //Insert Head for Single Linked List
char charFnITSLL(); //Insert Tail for Single Linked List

//DELETION SLL
void vdFnDHSLL(); //Delete Head for Single Linked List
void vdFnDTSLL(); //Delete Tail for Single Linked List
void vdFnSDSLL(); //Search and Delete for Single Linked List

//PRINT SLL
void vdFnPSSLL(); //Print String for Single Linked List

//=========================SINGLE LINKED LIST FUNCTION PROTOTYPING========================

//=========================DOUBLY LINKED LIST FUNCTION PROTOTYPING========================

//INSERTION DLL
char charFnIHDLL(); //Insert Head for Doubly Linked List
char charFnITDLL(); //Insert Tail for Doubly Linked List

//DELETION DLL
void vdFnDHDLL(); //Delete Head for Doubly Linked List
void vdFnDTDLL(); //Delete Tail for Doubly Linked List
void vdFnSDDLL(); //Search and Delete for Doubly Linked List

//PRINT DLL
void vdFnPSDLL(); //Print String for Doubly Linked List
        ...
        //If we receive an input that does not consist of a whitespice. AKA, request to print or delete something (that doesn't require a search for a node in the middle). 
            ...
            //SLL Print - SLL PS(5)
                ...
                if (sll.isEmpty()) {
                    ...
                    std::cout << "SLL: Printing Singly Linked List";
                    std::cout << std::endl << std::endl;
                    sll.printAll();
                }
    ...
    if (head != 0)                     // if non-empty list;
        if (head == tail && el == head->info) { // if only one
            ...
            if (tmp != 0) {
                ...
                std::cout << "SLL: There is no such node in the list!";
                std::cout << std::endl << std::endl;
            }
        }
}
